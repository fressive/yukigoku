...
define gui.about = _p("""
https://github.com/fressive/yukigoku
""")
...
define config.sample_sound = "audio/sound_train_01.mp3"
define config.sample_voice = "audio/voice_yk_001.mp3"


## 将以下语句取消注释就可以设置标题界面播放的背景音乐文件。此文件将在整个游戏中
## 持续播放，直至音乐停止或其他文件开始播放。

# define config.main_menu_music = "audio/bgm 001.mp3"
...
default preferences.text_cps = 14
...
define config.save_directory = "yukigoku-1672918673"
